...
#Step 1:
# sudo docker build -t ci4211 .
#Step 2:
# sudo docker run --name=ci4211 -dit --restart unless-stopped -p 90:80 -v $(pwd):/var/www/html/  ci4211:latest
#Step 3:
# sudo docker exec -it ci4211 /bin/bash
#Step 4:
...
#Step 5:
#root@aedf3a0e087d:/var/www/html# ln -s /mnt/pro_doc/uploaded_documents ~ ./uploaded_documents
