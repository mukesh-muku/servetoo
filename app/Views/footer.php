<footer class="bg-light">
    ...
    <div class=" row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
            <div class="widget">
                <img class="mb-4" src="<?=base_url();?>/assets/img/logo-dark.png" srcset="<?=base_url();?>/assets/img/servetoo_logo.jpg 2x" alt="" />
                <p class="mb-4">© 2023 Servetoo. <br class="d-none d-lg-block" />All rights reserved.</p>
        ...
        <div class="col-md-4 col-lg-3">
            <div class="widget">
                ...
                <a href="mailto:#" class="link-body">info@servetoo.com</a><br /> 9345314411
            </div>
            <!-- /.widget -->
        </div>
        <!-- /column -->
        <div class="col-md-4 col-lg-3">
            <div class="widget">
                ...
                <ul class="list-unstyled text-reset mb-0">
                    ...
                    <li><a href="<?=base_url();?>/">Our Story</a></li>
